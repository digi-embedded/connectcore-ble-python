...
project = digi.ccble.__description__
copyright = digi.ccble.__copyright__
author = digi.ccble.__author__
...
version = digi.ccble.__version__
# The full version, including alpha/beta/rc tags.
release = digi.ccble.__version__
...
html_theme_options = {
    ...
    # 'vcs_pageview_mode': '',
    'style_nav_header_background': '#2980B9',  # 'white',
    # Toc options
...
htmlhelp_basename = 'ConnectCoreBLEPythonLibraryDoc'
...
latex_documents = [
    (master_doc, 'ConnectCoreBLEPythonLibrary.tex', u'ConnectCore Bluetooth Low'
                                                    u'Energy Python Library'
                                                    u'Documentation',
     author, 'manual'),
]
...
man_pages = [(master_doc, 'ConnectCoreBLEPythonLibrary',
              u'ConnectCore Bluetooth Low Energy Python Library Documentation',
              [author], 1)]
...
texinfo_documents = [
    (master_doc, 'ConnectCoreBLEPythonLibrary', u'ConnectCore Bluetooth Low '
                                                u'Energy Python Library '
                                                u'Documentation',
     author, 'ConnectCoreBLEPythonLibrary', 'One line description of project.',
     'Miscellaneous'),
]
